...
function gui_addArea(id) {
	...
	temp+= '<option value="circle"    >cercle</option>';
	temp+= '<option value="poly"   >polygone</option>';
	temp+= '</select>';
	...
	temp+= 'Cible: <select name="img_target" class="img_target">';
	temp+= '<option value=""  >&lt;non d&eacute;finie&gt;</option>';
	temp+= '<option value="_self"  >Fen&ecirc;tre en cours</option>';
	temp+= '<option value="_blank" >Nouvelle fen&ecirc;tre</option>';
	temp+= '<option value="_top"   >Top fen&ecirc;tre</option>';
	temp+= '</select>';
