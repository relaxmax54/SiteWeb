		...
		<div class="ckpopupwizard_slider">
			...
			<div class="ckpopupwizard_options_area">
				<div id="ckpopupwizard_typeoflayout_default">
					<img src="<?php echo $this->getPathToElements() ?>/ckmaximenuwizard/default_layout.png" width="450" height="142" />
				</div>
				<div id="ckpopupwizard_typeoflayout_pushdown">
					<img src="<?php echo $this->getPathToElements() ?>/ckmaximenuwizard/pushdown_layout.png" width="450" height="142" />
				</div>
				<div id="ckpopupwizard_typeoflayout_nativejoomla">
					<img src="<?php echo $this->getPathToElements() ?>/ckmaximenuwizard/nativejoomla_layout.png" width="450" height="198" />
				</div>
				<div id="ckpopupwizard_typeoflayout_dropselect">
					<img src="<?php echo $this->getPathToElements() ?>/ckmaximenuwizard/dropselect_layout.png" width="400" height="142" />
				</div>
				<div id="ckpopupwizard_typeoflayout_flatlist">
					<img src="<?php echo $this->getPathToElements() ?>/ckmaximenuwizard/flatlist_layout.png" width="450" height="142" />
				</div>
			</div>
		</div>
		<div class="ckpopupwizard_slider">
			...
			<div class="ckpopupwizard_optionsselect_area">
				...
				<div  class="ckpopupwizard_options_area" style="width:200px;float: left;margin-left:20px;">
					<div id="ckpopupwizard_mobileoptions_normal">
						<img src="<?php echo $this->getPathToElements() ?>/ckmaximenuwizard/mobilemenu_normal.png" width="200" height="auto" />
					</div>
					<div id="ckpopupwizard_mobileoptions_slideleft">
						<img src="<?php echo $this->getPathToElements() ?>/ckmaximenuwizard/mobilemenu_slideleft.png" width="200" height="auto" />
					</div>
					<div id="ckpopupwizard_mobileoptions_slideright">
						<img src="<?php echo $this->getPathToElements() ?>/ckmaximenuwizard/mobilemenu_slideright.png" width="200" height="auto" />
					</div>
					<div id="ckpopupwizard_mobileoptions_topfixed">
						<img src="<?php echo $this->getPathToElements() ?>/ckmaximenuwizard/mobilemenu_topfixed.png" width="200" height="auto" />
					</div>
				</div>
			</div>
			<?php else: ?>
